...
public class StringWithVowelsTest {
    ...
    public void test1() {
        ...
        assertArrayEquals(expectedOutput1, StringWithVowels.getStringsWithVowels(input1));
    }
    ...
    public void test2() {
        ...
        assertArrayEquals(expectedOutput2, StringWithVowels.getStringsWithVowels(input2));
    }
    ...
    public void test3() {
        ...
        assertArrayEquals(expectedOutput3, StringWithVowels.getStringsWithVowels(input3));
    }
    ...
    public void test4() {
        ...
        assertArrayEquals(expectedOutput4, StringWithVowels.getStringsWithVowels(input4));
    }
}